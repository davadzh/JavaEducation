...
public class NewsController {
    ...
    public ResponseEntity<String> CreateNews(NewsPostDto newsPostDto) {
    ...
    public ResponseEntity<String> DeleteNewsById(NewsDeleteDto newsDeleteDto) {
    ...
    public ResponseEntity<String> UpdateNews(NewsUpdateDto newsUpdateDto) {
